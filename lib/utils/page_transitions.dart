...
class ModernPageTransition extends PageRouteBuilder {
  ...
  ModernPageTransition({required this.child, this.heroTag})
    : super(
...
class SlideUpTransition extends PageRouteBuilder {
  ...
  SlideUpTransition({required this.child, this.isFullScreen = false})
    : super(
        pageBuilder: (context, animation, secondaryAnimation) => child,
        transitionsBuilder: (context, animation, secondaryAnimation, child) {
          final slideAnimation =
...
class ScaleTransition extends PageRouteBuilder {
  ...
  ScaleTransition({required this.child})
    : super(
        pageBuilder: (context, animation, secondaryAnimation) => child,
        transitionsBuilder: (context, animation, secondaryAnimation, child) {
...
class PageTransitions {
  ...
  static SlideUpTransition slideFromBottom<T>(
    Widget page, {
