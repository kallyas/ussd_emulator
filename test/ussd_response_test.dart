...
void main() {
  group('UssdResponse', () {
    test('should parse CON response correctly', () {
      const textResponse = 'CON Welcome to our service\n1. Check Balance\n2. Buy Airtime';
    ...
    test('should parse END response correctly', () {
      const textResponse = 'END Thank you for using our service!\nYour balance is \$10.50';
      
      final response = UssdResponse.fromTextResponse(textResponse);
      
      expect(response.text, 'Thank you for using our service!\nYour balance is \$10.50');
